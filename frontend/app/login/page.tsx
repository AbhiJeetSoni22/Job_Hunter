...
function LoginContent() {
  ...
  // Handle errors from OAuth callback redirects
  useEffect(() => {
  ...
  return (
    <div
      className="max-w-md mx-auto mt-12 p-6 rounded-xl border shadow-sm"
    ...
    >
      ...
      <p className="text-sm mb-6" style={{ color: "var(--color-subtle)" }}>
        {step === "email"
          ? "Access your dashboard with Google or a secure email verification code."
        ...
        <form onSubmit={handleVerifyOtp} className="flex flex-col gap-4">
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-xs font-medium" style={{ color: "var(--color-subtle)" }}>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-md text-lg tracking-widest font-mono text-center border focus:outline-none"
              style={{
                background: "var(--color-bg)",
                borderColor: "var(--color-border)",
                color: "var(--color-text)",
